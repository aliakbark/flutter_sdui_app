...
class SduiColumn extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final spacing = TypeUtils.toDouble(properties['spacing']) ?? themeTokens.getSpaceMd();
    final mainAxisAlignment = _getMainAxisAlignment(properties['mainAxisAlignment'] as String?);
    final crossAxisAlignment = _getCrossAxisAlignment(properties['crossAxisAlignment'] as String?);
    ...
    return Column(
      ...
      children: children.asMap().entries.map((entry) {
        ...
        final widget = SduiRenderer.renderWidget(childConfig, themeTokens, controller);
